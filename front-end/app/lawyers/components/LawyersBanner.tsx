...
export default function LawyersBanner() {
    ...
    return (
        <div className="text-[clamp(24px,7vw,40px)] bg-[#e8e8e8]">
            <div className="pt-[min(1.0833333333em,56px)] pb-[calc(120px+.6em)] gap-[min(.3333333333em,12px)] flex flex-col items-center justify-center bg-[url(/images/lawyers/lawyer-head.svg)] bg-bottom bg-repeat-x bg-[#e5f0f2]">
