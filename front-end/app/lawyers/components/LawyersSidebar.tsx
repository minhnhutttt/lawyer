            ...
            <aside className="bg-[#f6f6f6] rounded-[8px] sticky top-[16px] z-auto flex gap-4 flex-col">
              <div className="px-4 flex flex-col rounded divide-y divide-[#d9d9d9]">
                <div className="flex flex-col pt-4">
                  <h3 className="flex items-center md:text-[14px] text-[12px] font-bold gap-1.5 md:mb-3.5 mb-3 before:size-[16.875px] before:bg-[url(/images/icons/location.svg)] before:bg-contain before:bg-center before:bg-no-repeat">地域から探す</h3>
                  ...
                  <div className="flex items-center justify-center my-1">
                    <button onClick={() => setLocationOpen(!locationOpen)} className={cn('size-10 flex items-center justify-center', locationOpen && 'rotate-180')}>
                      <Image src="/images/icons/arrow-down.svg" alt="" width={16} height={16} />
                    </button>
                  </div>
                </div>
                <div className="flex flex-col pt-4">
                  <h3 className="flex items-center md:text-[14px] text-[12px] font-bold gap-1.5 md:mb-3.5 mb-3 before:size-[16.875px] before:bg-[url(/images/icons/field.svg)] before:bg-contain before:bg-center before:bg-no-repeat">分野から探す</h3>
                ...
                <div className="flex items-center gap-4 py-4">
                  <h3 className="flex items-center md:text-[14px] text-[12px] font-bold gap-1.5 before:size-[16.875px] before:bg-[url(/images/icons/tag.svg)] before:bg-contain before:bg-center before:bg-no-repeat">よく見られる条件</h3>
