...
export default function FindLawyer() {
    const findBtns = [
        { type: "find", iconUrl: "/icons/icon_area_2x.svg", text: "地域", url: "#" },
        { type: "find", iconUrl: "/icons/icon_line_2x.svg", text: "駅・路線", url: "#" },
    ...
    return (
        <div>
            <h2 className="flex items-center gap-2 px-4 py-2 bg-[#eaeaea] font-bold mb-6">
                <Image src="/icons/icon_find_lawyer.svg" alt="弁護士を探す" width={40} height={40} className="flex-shrink-0" />
                <span>弁護士を探す</span>
            </h2>
