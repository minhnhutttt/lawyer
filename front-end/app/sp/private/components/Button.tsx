  ...
  switch (btn.type) {
      ...
      return (
        ...
        >
          <div className="w-5 h-5 bg-[#ff9900] rounded-full flex items-center justify-center absolute left-2 top-1/2 -translate-y-1/2 pointer-events-none">
            <Image src="/images/icons/icon_tel_w.png" alt="Icon Tel" width={16} height={16} />
          </div>
          電話で<br />面談予約
        </Link>
      )
    ...
    case "contact":
      return (
        ...
        >
          <div className="w-5 h-5 bg-[#ff9900] rounded-full flex items-center justify-center absolute left-2 top-1/2 -translate-y-1/2 pointer-events-none">
            <Image src="/images/icons/icon_mail_w.png" alt="Icon Mail" width={16} height={16} />
          </div>
          メールで<br />面談予約
        </Link>
      )
      ...
      return (
        ...
        >
          <div className="w-5 h-5 bg-[#ff9900] rounded-full flex items-center justify-center absolute right-2 top-1/2 -translate-y-1/2 pointer-events-none">
            <Image src="/images/icons/icon_arrowRight_w.png" alt="Icon Tel" width={16} height={16} />
          </div>
