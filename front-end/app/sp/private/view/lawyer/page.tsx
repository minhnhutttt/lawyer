  ...
  const allLawyers = [
    {
      ...
      focusAreas: [
        { iconUrl: "/images/icons/f2_color.svg", text: "交通事故" },
        { iconUrl: "/images/icons/f3_color.svg", text: "離婚・男女問題" },
        { iconUrl: "/images/icons/f4_color.svg", text: "遺産相続" },
        { iconUrl: "/images/icons/f5_color.svg", text: "労働問題" },
        { iconUrl: "/images/icons/f6_color.svg", text: "債権回収" },
        { iconUrl: "/images/icons/f12_color.svg", text: "不動産・建築" },
        { iconUrl: "/images/icons/f13_color.svg", text: "企業法務・顧問弁護士" },
      ],
      isWishlisted: true,
    },
    {
      ...
      focusAreas: [
        { iconUrl: "/images/icons/f3_color.svg", text: "離婚・男女問題" },
        { iconUrl: "/images/icons/f5_color.svg", text: "労働問題" },
        { iconUrl: "/images/icons/f13_color.svg", text: "犯罪・刑事事件" },
      ],
      btnList: [
    ...
    },
    {
      ...
      focusAreas: [
        { iconUrl: "/images/icons/f1_color.svg", text: "借金・債務整理" },
      ],
      btnList: [
