...
const HistoryLocalItem = ({ link, image, name, location, walk, time, introduction }: SearchHistoryLocalItem) => (
  <Link href={link} className="lg:flex-[0_0_33.33333333%] md:flex-[0_0_41.66666667%] flex-[0_0_75%] px-2">
