      ...
      <div className="flex items-start justify-between max-md:gap-2">
        <button onClick={() => setTab(0)}
          className={cn(
            ...
            tab === 0 ? 'border-b-none rounded-tl-[5px] rounded-br-none rounded-tr-[5px] rounded-bl-none [box-shadow:0_0_0_#fff,_inset_1px_0_0_#ddd,_inset_0_1px_0_#ddd,_inset_-1px_0_0_#ddd] text-[#375165] py-4 md:py-3' : 'py-3 md:py-2 bg-[linear-gradient(#fdfdfd,_#f8f8f8)]'
          )}>
        ...
        <button onClick={() => setTab(1)}
          className={cn(
            ...
            tab === 1 ? 'border-b-none rounded-tl-[5px] rounded-br-none rounded-tr-[5px] rounded-bl-none [box-shadow:0_0_0_#fff,_inset_1px_0_0_#ddd,_inset_0_1px_0_#ddd,_inset_-1px_0_0_#ddd] text-[#375165] py-4 md:py-3' : 'py-3 md:py-2 bg-[linear-gradient(#fdfdfd,_#f8f8f8)]'
          )}>
          ...
          <span className="bg-[#fff] border-[1px] border-[solid] border-[#ddd] rounded-[3px] inline-block text-[.7em] leading-[1.2] ml-[8px] mr-[5px] -my-[4px] relative text-center align-middle">
            <span className="border-r-[1px_solid_#eee] text-[#375165] block md:float-left px-[5px] py-[9px] text-[9px] leading-[1.2] text-center">直近30日</span>
            <span className="block md:float-right pt-[3px] px-[5px] pb-[0] text-left [box-shadow:0_0_0_#f0f0f0,_inset_0_1px_2px_hsla(0,_0%,_39%,_.3)] text-[#999] bg-[linear-gradient(#eee,_#e3e3e3)]">
              <span className="text-[#375165]">相談数</span>
            ...
            <form action="" className={cn(tab == 0 ? 'block' : 'hidden')}>
              <div className="flex justify-between items-center max-md:flex-col">
                <div className="flex items-center gap-3 md:gap-1 max-md:flex-col">
                  ...
                  />
                  <div className="flex max-md:w-full">
                    <p className="size-[38px] text-[11px] text-[#375165] font-bold bg-white border border-[#ddd] flex items-center justify-center">分野</p>
                    <div className="relative flex items-center after:absolute after:right-2 after:bg-[url(/images/icon_arrow_downS.png)] after:bg-cover after:w-[7px] after:h-[5px]">
